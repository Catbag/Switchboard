...
public class Preferences {
     ...
     */
    public static boolean setDynamicConfigServerUrl(Context c, String updateServerUrl, String
            configServerUrl) {
    ...
    static private Object getPreferenceObject(Context ctx, boolean writeable) {
        ...
        if (!writeable) {
            returnValue = sharedDelegate.getSharedPreferences(switchBoardSettings, Context
                    .MODE_PRIVATE);
        } else {
            returnValue = sharedDelegate.getSharedPreferences(switchBoardSettings, Context
                    .MODE_PRIVATE).edit();
